<?php
    ...
    session_start();
    define('TITLE',"Create Blog | CyberWarior");
...
<body>
    ...
    <div class="bg-contact2" style="background-image: url('img/cyberwarior.jpg');">
			...
			<div class="wrap-contact2">
                            <form class="contact2-form" action="includes/create-blog.inc.php" method='post' 
                                  enctype="multipart/form-data">
                                        ...
                                        <img class="cover-img " id="blah"  src="img/blog-coverc.png"> 
