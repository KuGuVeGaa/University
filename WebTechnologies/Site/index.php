...
<?php
    ...
    define('TITLE',"Dashboard | CyberWarior");

    $companyName = "CyberWarior";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <div class="text-center p-3">
                            <img style="width: 200px;"src="img/cyberwarior.png">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/cyberwarior.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result))
                                            {
                                                echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block blogindex-cover" 
                                                                src="img/forum-cover.jpg" alt="Card image cap">
                                                                </a>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            echo '<a href="poll.php?poll='.$row['id'].'">
                                                <div class="media text-muted pt-3">
                                                    <img src="img/poll.png" alt="" class="mr-2 rounded div-img poll-img">
