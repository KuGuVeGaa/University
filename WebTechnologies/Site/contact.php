<?php
    ...
    session_start();
    define('TITLE',"Contact Us | CyberWarior");
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('img/contact.jpg');">
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt2">
                                                   We are university students and help us to make it better.
						</span>
					</div>
				</div>
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							<a href="gitbub.com/kuguvegaa">Kuguvega</a>
						</span>
					</div>
				</div>
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							<a href="maltego:kuguvega@linuxmail.org">kuguvega@linuxmail.org</a>
						</span>
					</div>
				</div>
                            <?php
